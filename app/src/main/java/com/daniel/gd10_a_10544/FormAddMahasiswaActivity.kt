...
import com.daniel.gd10_a_10544.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    fun saveData(){
        with(binding) {
            ...
            RClient.instance.createData(nobp,nama,alamat,prodi,lahir).enqueue( object : Callback<ResponseCreate>{
